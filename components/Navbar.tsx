  ...
  return (
    <header className="fixed top-5 inset-x-0 z-50 px-3 md:px-4">
      <div className="max-w-3xl mx-auto backdrop-blur-xl bg-slate-900/70 border border-slate-800/80 rounded-full px-2 py-1.5 md:px-3 md:py-2 shadow-xl flex justify-between items-center w-full" dir="ltr">
        ...
        <Link href="#about" className="hidden sm:block text-sm md:text-base font-black tracking-wider bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent hover:scale-105 transition-transform duration-300 pl-2 shrink-0">
          M. AL-NEGHIMSHI
        </Link>
        ...
        <div className="flex items-center justify-between sm:justify-end w-full sm:w-auto gap-2 md:gap-5">
          <nav className="flex items-center gap-0.5 md:gap-1 text-[10px] md:text-sm font-bold">
            {/* لاحظ الـ href صار بـ هاشتاج # */}
            <Link href="#about" className="px-2 md:px-4 py-1.5 rounded-full text-slate-400 hover:text-emerald-400 hover:bg-slate-950/80 transition-all duration-300">About</Link>
